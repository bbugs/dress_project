...
# get the image paths
img_root = '../DATASETS/'
fname = img_root + '/dress_attributes/data/paths/paths_dress.txt'
...
fout_name = '../DATASETS/dress_attributes/cnn/cnn_dress_' + target_layer + '.txt'
...
img_paths = img_paths
cnn = np.zeros((cnn_dim,len(img_paths)))
i = 0
